        ...
        private class SimpleTypeObjectGenerator
        {
            ...
            private static Dictionary<Type, Func<long, object>> InitializeGenerators()
            {
                return new Dictionary<Type, Func<long, object>>
                {
                    ...
                    {
                        typeof(string),
                        index => string.Format(CultureInfo.CurrentCulture, "sample string {0}", index)
                    },
                    {
                    ...
                    {
                        typeof(Uri),
                        index => new Uri(string.Format(CultureInfo.CurrentCulture, "http://webapihelppage{0}.com", index))
                    }
                };
            }
